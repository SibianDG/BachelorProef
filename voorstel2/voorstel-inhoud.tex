...
Ook zal er op basis van de beschikbare literatuur onderzocht worden welke soort machinaal leren of \textit{deep learning} het meest geschikt is om deze parameters te integreren in het model.
...
Ten slotte moet alles omgezet worden naar een duidelijke webapplicatie via ``Flask'' zodat het in latere fases niet geïnstalleerd moet worden op een computer. Op deze manier kan iedereen die thuis of op verplaatsing is, zoals in een rusthuis, de applicatie gebruiken zonder iets te installeren. %TODO: eers ik, dan lief
