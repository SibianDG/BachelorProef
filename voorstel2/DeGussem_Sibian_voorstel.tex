...
\Abstract{Deze bachelorproef zal verder werken op twee eerder gepubliceerde onderzoeken van \textcite{Beeckman2021} en \textcite{Standaert2021} en zal op een softwarematige manier kijken of er bij een stukje audio \textit{elderspeak} wordt toegepast. Een webapplicatie zal aanduiden of er verkleinwoorden, vertroetelingen aanwezig waren, of er veel herhaald werd en of de toonhoogte hoger is dan anders. Dit zal gerealiseerd worden met Python, spraakherkenning, herkenningsmethoden, \textit{Machine Learning} of \textit{Deep Learning} en als laatste zal dit gepresenteerd worden via een webapplicatie met ``Flask'' als \textit{back-end}.
}
