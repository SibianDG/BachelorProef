...
\Abstract{In deze bachelorproef zal er worden verder gewerkt aan twee voorgaande eindwerken waarbij men op een softwarematige manier kijkt of bij een stukje audio \textit{elderspeak} wordt toegepast. Een webapplicatie zal dit aanduiden, alsook welke eigenschappen herkend waren. Dit zal gerealiseerd worden met Python, spraakherkenning, herkenningsmethoden, \textit{Machine Learning} of \textit{Deep Learning} en als laatste zal dit gepresenteerd worden via een webapplicatie met ``Flask'' als \textit{back-end}.
}
